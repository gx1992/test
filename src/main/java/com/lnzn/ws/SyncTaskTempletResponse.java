...
/**
 * <p>sync_task_templetResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="sync_task_templetResponse">
 *   &lt;complexContent>
...
@XmlType(name = "sync_task_templetResponse", propOrder = {
    "resConf"
})
public class SyncTaskTempletResponse {
