...
/**
 * <p>send_fault_valueResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="send_fault_valueResponse">
 *   &lt;complexContent>
...
@XmlType(name = "send_fault_valueResponse", propOrder = {
    "resConf"
})
public class SendFaultValueResponse {
