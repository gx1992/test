...
/**
 * <p>send_patrol_dataResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="send_patrol_dataResponse">
 *   &lt;complexContent>
...
@XmlType(name = "send_patrol_dataResponse", propOrder = {
    "resConf"
})
public class SendPatrolDataResponse {
