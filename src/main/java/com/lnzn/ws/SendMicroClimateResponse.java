...
/**
 * <p>send_micro_climateResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="send_micro_climateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "send_micro_climateResponse", propOrder = {
    "resConf"
})
public class SendMicroClimateResponse {
