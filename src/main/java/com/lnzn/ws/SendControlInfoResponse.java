...
/**
 * <p>send_control_infoResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="send_control_infoResponse">
 *   &lt;complexContent>
...
@XmlType(name = "send_control_infoResponse", propOrder = {
    "resConf"
})
public class SendControlInfoResponse {
