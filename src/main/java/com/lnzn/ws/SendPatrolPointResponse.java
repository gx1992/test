...
/**
 * <p>send_patrol_pointResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="send_patrol_pointResponse">
 *   &lt;complexContent>
...
@XmlType(name = "send_patrol_pointResponse", propOrder = {
    "resConf"
})
public class SendPatrolPointResponse {
