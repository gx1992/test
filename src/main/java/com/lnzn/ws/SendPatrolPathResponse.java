...
/**
 * <p>send_patrol_pathResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="send_patrol_pathResponse">
 *   &lt;complexContent>
...
@XmlType(name = "send_patrol_pathResponse", propOrder = {
    "resConf"
})
public class SendPatrolPathResponse {
