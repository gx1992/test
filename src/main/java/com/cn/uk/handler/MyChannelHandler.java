package com.cn.uk.handler;

import com.alibaba.fastjson.JSON;
import com.cn.uk.util.GlobalUserUtil;
...
public class MyChannelHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private static final String URI = "/XMLReceiver.cgi";
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println("Netty Server 收到的数据 : " + msg);
        if (null != msg && msg instanceof HttpRequest) {
    ...
    private Map<String, Object> getRequestParams(HttpRequest request) {
